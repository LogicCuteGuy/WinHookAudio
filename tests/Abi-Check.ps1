...
$required = @('counts_1_to_512', 'empty_counts_silent', 'name_truncation_32', 'loopback_virtual_only', 'bridge_inside_pool', 'network_streams_8', 'master_clock_defaults', 'shm_names_unique', 'shm_sizes_fixed', 'slots_json_roundtrip', 'slots_json_rejects', 'bridge_region', 'whaa_packet')
